...
ordering_genes <- row.names(subset(Neu_DEG_genes, qval < 0.0001))
length(ordering_genes)
gene_id <- row.names(Neu_DEG_genes)[order(Neu_DEG_genes$qval)][1:950] # 1000 1000 1200 2300
...
# 选择根节点，重新排序
#monocle_cds <- orderCells(monocle_cds, root_state = 2) # Neu_CCL3 Neu_IFIT3是老化细胞，Neu_S100A12 Neu_OSM是成熟细胞
