...
if(F){
  possible.cancer.cell <- rownames(data.merge@meta.data)[data.merge@meta.data$cellType_low %in% c("c0", "c1", "c2", "c3", "c4", "c5") &
...
if(T){
  ...
  cluster_colors = list(c("c0" = "#8DA3A6", "c1" = "#57A2AC", "c2" = "#7EB875", "c3" = "#4E78C4","c4" = "#F0A38B", "c5" = "#B48374")) #, "R5" = "#421510"
  ...
  pdf("./1.0all_cnv_heatmaps.pdf", width = 10, height = 3.8)
  draw(
    list_heatmaps[[1]],
